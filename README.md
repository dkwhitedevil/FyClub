## 🥊 FY Club — Fight For You Club

**The First Rule of DeFi Safety is Protection**

An AI-powered on-chain security agent for DeFi treasuries. FY Club doesn't react to loss—**it prevents loss**.
...
- 💬 **GitHub Discussion:** https://github.com/IQAIcom/adk-ts/discussions/
...
FY Club is built with ❤️ for DeFi security and submitted to the **AGENT ARENA – AI Agent Hackathon**.
...
> **FY Club — Fight For You. The First Rule of DeFi Safety is Protection.**
...
**Built with AI. Secured by Intelligence. Protected by FY Club.** 🚀
